...
MKLROOT=/export/opt/intel/compilers_and_libraries/linux/mkl

CC = mpicc -O3 -ffast-math -fopenmp -I/home/parq/include
FC = mpif90 -O3 -ffast-math -fopenmp -I$(MKLROOT)/include
LIB= -L/home/parq/lib -lfftw3 -L$(MKLROOT)/lib/intel64_lin -lmkl_intel_lp64 -lmkl_gnu_thread -lmkl_core -lpthread -lgfortran
...
Cluster_DFT_alpha.o: Cluster_DFT_alpha.c openmx_common.h
	$(CC) -c Cluster_DFT_alpha.c
...
Dr_VH_AtomF.o: Dr_VH_AtomF.c openmx_common.h
	$(CC) -c Dr_VH_AtomF.c
DenRF.o: DenRF.c openmx_common.h
	$(CC) -c DenRF.c
